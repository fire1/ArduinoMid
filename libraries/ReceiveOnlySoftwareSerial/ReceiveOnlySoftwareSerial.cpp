...
#error This version of ReceiveOnlySoftwareSerial supports only 20, 16 and 8MHz processors
...
bool ReceiveOnlySoftwareSerial::listen()
{
...
// Constructor
//
ReceiveOnlySoftwareSerial::ReceiveOnlySoftwareSerial(uint8_t receivePin, bool inverse_logic /* = false */) : 
...
// Destructor
//
ReceiveOnlySoftwareSerial::~ReceiveOnlySoftwareSerial()
{
  end();
}
...
void ReceiveOnlySoftwareSerial::begin(long speed)
{
...
size_t ReceiveOnlySoftwareSerial::write(uint8_t b)
{
    return 0;
}
